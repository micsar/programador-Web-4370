window.onload = function () {
  ...
  function removeStudentNode(dniToBeRemoved) {
    var li = document.getElementById(dniToBeRemoved)
    li.remove()
  }
  ...
  function addStudent() {
    ...
    dataStore.push(student) // actualiza en el local store la info nueva
  ...
  function deleteStudent() {
    var dniToBeRemoved = deleteDni.value
    var dniRemoved = removeStudentFromDatastore(dataStore, dniToBeRemoved)
    if (dniRemoved) {
      setLocalList(KEY_STORE, dataStore)
      removeStudentNode(dniToBeRemoved)
